...
const fetchUserBasicInformations = require('../controllers/authentication/fetchUserBasicInformations.js')
...
router.route('/user-role').post(verifyTokenMiddleware, defineUserRole)
router.route("/verify-token").get(verifyToken);
router.route("/user-basic-informations").get(verifyTokenMiddleware, fetchUserBasicInformations);
