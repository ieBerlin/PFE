  ...
  return (
    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
      <div className="flex flex-col w-full h-full items-center justify-center px-4 ">
        <CheckIcon
          className={`h-12 w-12 text-${color}-600 p-3 bg-${color}-100 rounded-full`}
          aria-hidden="true"
        />
        ...
        <button
          onClick={onClose}
          className={`mt-4 bg-${color}-500 text-white font-semibold rounded-md px-32 py-1 hover:bg-${color}-600`}
        >
          Go back
        </button>
      </div>
